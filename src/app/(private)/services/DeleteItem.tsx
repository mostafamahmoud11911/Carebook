        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <Button disabled={mutation.isPending} onClick={() => mutation.mutate(service.id)} className="flex items-center mt-3 justify-end gap-2 rounded-md bg-red-500 hover:bg-red-700 p-2 px-4 cursor-pointer text-white">Delete</Button>
            </DialogDescription>
          </DialogHeader>
        </DialogContent>
      </Dialog>
